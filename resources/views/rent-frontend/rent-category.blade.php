            ...
            <div class="col-lg-3 col-md-3 d-none d-lg-block d-md-none">
                <div class="filter-container">
                    ...
                    <form action="{{ route('filter.location') }}" method="post">
                        ...
                        <button type="submit" class="btn btn-success">Filter Location</button>
                    </form>
                    <br>
            ...
            <div class="col-lg-9">
                <div class="quicktech-categories-product-inner">
                    <div class="quicktech-categories-head">
                        <h6>{{ $properties->count() }} properties found</h6>
                        <h4>Home/</h4>
                    </div>
                </div>
                <div class="row mt-4">
                        ...
                        <div class="quicktech-product-main-inner">
                            <div class="quiktech-categor-p-img">
                                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        @foreach ($property->multi_images as $key => $multi_image)
                            ...
                            <div class="quicktech-categories-p-details">
                                ...
                                <ul class="quicktech-offers">
                                    ...
                                    <li><img src="{{ asset('rent-frontend/images') }}/gender-equality.png" alt="">{{ $property->gender }} Resident</li>
                                    <li><img src="{{ asset('rent-frontend/images') }}/student.png" alt="">{{ $property->resident_type }}</li>
