    ...
    <form action="{{ route('admin.package.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-solid @error('name') is-invalid @enderror" id="name" placeholder="Enter Name" name="name"
                value="{{ old('name') }}">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control form-control-solid @error('price') is-invalid @enderror" id="price" placeholder="Enter Price" name="price"
                value="{{ old('price') }}">
                @error('price')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control form-control-solid @error('maximum_post') is-invalid @enderror" id="maximum_post" placeholder="Enter Maximum Post" name="maximum_post"
                value="{{ old('maximum_post') }}">
                @error('maximum_post')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control form-control-solid @error('duration') is-invalid @enderror" id="duration" placeholder="Enter Duration" name="duration"
                value="{{ old('duration') }}">
                @error('duration')
                <p class="text-danger">{{ $message }}</p>
                @enderror
