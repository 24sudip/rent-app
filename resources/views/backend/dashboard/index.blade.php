        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="box-com box-qui box-lig box-new-user ali-cen">
                    ...
                    <div class="users-cir-thum-hori">
                        <span>
                            <img src="{{ asset('admin-backend/images/profiles/1.jpg') }}" data-bs-toggle="tooltip">
                        </span>
                        <span>
                            <img src="{{ asset('admin-backend/images/profiles/10.jpg') }}" data-bs-toggle="tooltip">
                        </span>
                        <span>
                            <img src="{{ asset('admin-backend/images/profiles/11.jpg') }}" data-bs-toggle="tooltip">
                        </span>
                        <span>
                            <img src="{{ asset('admin-backend/images/profiles/12.jpg') }}" data-bs-toggle="tooltip">
                        </span>
                        <span>
                            <img src="{{ asset('admin-backend/images/profiles/13.jpg') }}" data-bs-toggle="tooltip">
                        </span>
                        <span>
                            <img src="{{ asset('admin-backend/images/profiles/14.jpg') }}" data-bs-toggle="tooltip">
                        </span>
                    </div>
                </div>
                <div class="box-com box-qui box-lig ali-cen">
            ...
            <div class="col-md-6">
                <div class="box-com box-qui box-lig ali-cen">
                    ...
                    <span class="bnum">
                        &#2547;
                        {{-- {{ number_format(array_sum($monthlyEarnings), 2) }} --}} 4
                    </span>
