...
<div class="head-top">
    <div class="container">
        <div class="row">
            ...
            <div class="rhs">
                <ul>
                    <li><a href="tel:"><i class="fa fa-phone"
                                aria-hidden="true"></i>&nbsp;</a></li>
                    <li><a href="mailto:"><i class="fa fa-envelope-o"
                                aria-hidden="true"></i>&nbsp;</a></li>
    ...
    <div class="inn">
        ...
        <div class="menu-pop-help">
            ...
            <div class="user-bio">
                ...
                <a href="#" class="btn btn-primary btn-sm">Ask your doubts</a>
            </div>
        </div>
            ...
            <div class="hom-nav">
                ...
                <div class="logo">
                    ...
                    <a href="/" class="logo-brand">
                        <img src="{{ asset($generalsetting->logo) }}" alt="" loading="lazy" class="ic-logo">
                    </a>
                </div>
                ...
                <div class="al">
                    <div class="head-pro">
                        <img src="{{ asset(Auth::user()->profile ? Auth::user()->profile->image : 'frontend/images/logoo.png') }}" alt="" loading="lazy">
                        <b>Welcome</b><br>
