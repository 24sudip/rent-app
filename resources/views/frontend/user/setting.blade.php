                                ...
                                <div class="sett-lef">
                                    <div class="auth-pro-sm sett-pro-wid">
                                        ...
                                        <div class="auth-pro-sm-desc">
                                            ...
                                            <p>{{ Auth::user()->currentPackage()->name }} user </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="sett-rig">
                                ...
                                <div class="sett-rig">
                                    <div class="sett-select-drop">
                                        <select id="profileVisibility" onchange="updateSetting('profile_visibility', this.value)">
                                          <option value="all" {{ Auth::user()->profile_visibility==='all' ? 'selected' : '' }}>All users</option>
                                          <option value="premium" {{ Auth::user()->profile_visibility==='premium' ? 'selected' : '' }}>Premium</option>
                                          <option value="no-visible" {{ Auth::user()->profile_visibility==='no-visible' ? 'selected' : '' }}>No-more visible(You can't visible, so no one can view your profile)</option>
                                        </select>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="sett-rig">
                                    <div class="sett-select-drop">
                                        <select id="interestRequestAccess" onchange="updateSetting('interest_request_access', this.value)">
                                            <option value="all" {{ Auth::user()->interest_request_access==='all' ? 'selected' : '' }}>All users</option>
                                            <option value="premium" {{ Auth::user()->interest_request_access==='premium' ? 'selected' : '' }}>Premium</option>
                                        </select>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="fol-sett-box sett-acc-view sett-two-tab">
                        <ul>
                            ...
                            <li>
                                ...
                                <div>{{ Auth::user()->currentPackage()->name }}</div>
                            </li>
                        </ul>
                    </div>
                </div>
