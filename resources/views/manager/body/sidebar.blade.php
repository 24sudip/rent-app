...
<div class="quicktech-doctor-panel-menu">
    <a style="background-color:#ffe000; color:black;" href="{{ route('manager.dashboard') }}">
        <img src="{{ asset('rent-frontend/images') }}/dashboard.png" alt="" /> DASHBOARD
    </a>
    <a href="{{ route('manager.property.create') }}">
        <img src="{{ asset('rent-frontend/images') }}/deadline.png" alt="" />Post Property
    </a>
    <a  href="{{ route('manager.property.index') }}"><img src="{{ asset('rent-frontend/images') }}/deadline.png" alt="" />
        Property List
    </a>
    <a  href="{{ route('manager.buy.package') }}"><img src="{{ asset('rent-frontend/images') }}/crown.png" alt="" />
        All Package
    </a>
